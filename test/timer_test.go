...
func (logic *FakeTurnLogic) OnStartsWaitingNextParticipant(t time.Time, p Participant) {
	logic.Actions = append(logic.Actions, FakeTimerAction{t, "waiting_next_participant", p})
}
